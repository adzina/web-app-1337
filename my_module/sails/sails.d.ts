...
declare module Sails{
  ...
  export interface Model{
    ...
    count(criteria:Object,cb:(err:Error,found:number)=>void):any;
    count(criteria:Array<Object>,cb:(err:Error,found:number)=>void):any;
    count(criteria:string,cb:(err:Error,found:number)=>void):any;
    count(criteria:number,cb:(err:Error,found:number)=>void):any;
    ...
    query(sqlQuery:string,cb:(err:Error,results:Array<Record>)=>void):any;
    native(cb:(err:Error,collection:Model)=>void):any;
  ...
  export class QueryBuilder extends Promise<any>{
    exec(cb:(error:any,results:Array<QueryResult>)=>void):any;
