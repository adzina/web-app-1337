...
export class BackendService {
  ...
  getTeachersLessons(): Observable<Lesson[]> {
    ...
    return this.http
      ...
      .catch((error: any) =>
        Observable.throw("Error getting teacher's lessons")
      );
  }
  ...
  getAllMyGroups(): Observable<Group[]> {
    ...
    return this.http
      ...
      .map((res: Response) => res.json())
      .catch((error: any) =>
        Observable.throw("Error getting all user's groups")
      );
  }
  ...
  removeUserFromGroup(userID: string, groupID: string): Observable<any> {
    ...
    return this.http
      ...
      .map(res => res.json())
      .catch((error: any) =>
        Observable.throw("Error removing user form group")
      );
  }
  removeWordFromLesson(lessonID: string, wordID: string): Observable<any> {
    ...
    return this.http
      ...
      .map(res => res.json())
      .catch((error: any) =>
        Observable.throw("Error removing word from lesson")
      );
  }
  ...
  countAllWords(studentID: string): Observable<any> {
    ...
    return this.http
      .post(url, JSON.stringify({ studentID: studentID }))
      .map(res => res.json())
      .catch((error: any) => Observable.throw("Error counting words"));
  }
